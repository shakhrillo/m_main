            ...
            <div className="col-lg-7 col-md-7">
              <div className="me-lg-4 title-heading">
                ...
                <p className="text-muted para-desc">
                  Empowering businesses with cutting-edge technology, creative
                  design, and strategic solutions for lasting success.
                </p>
                <div className="mt-4">
      ...
      <section className="border-bottom border-top py-4">
        <div className="container">
          <div className="row justify-content-center">
            {technologies.map((e) => (
              <div className="col-6 col-lg-2 col-md-2 text-center py-4">
              ...
              <div className="col-lg-4 col-md-6 mt-4 pt-2">
                ...
                >
                  <div className="rounded-circle text-center h3 icon mb-0 me-3">
                    <i className={"text-primary bi bi-" + e.icon}></i>
                  </div>
        ...
        <div className="container position-relative z-1">
            ...
            <div className="col-md-8">
              <div className="text-center text-md-start section-title">
                ...
                <p className="text-muted mb-0 para-desc">
                  We prioritize reliability, flexibility, and customer
                  satisfaction to deliver the best experience.
                </p>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-12 col-md-3 mt-5">
              <div className="feature-primary features">
                <div className="d-inline-block position-relative image">
                  <i className="text-primary bi bi-palette h2"></i>
                </div>
                <div className="content mt-4">
                  <h5>Customizable White Label Solutions</h5>
                  <p className="text-muted mb-0">
                    Offer high-quality, fully customizable solutions under your
                    own brand.
                  </p>
                </div>
              </div>
            ...
            <div className="col-12 col-md-3 mt-5">
              <div className="feature-primary features">
                <div className="d-inline-block position-relative image">
                  <i className="text-primary bi bi-life-preserver h2"></i>
                </div>
                <div className="content mt-4">
                  <h5>24/7 Dedicated Support</h5>
                  <p className="text-muted mb-0">
                    Expert assistance whenever you need it, ensuring smooth
                    operations.
                  </p>
                </div>
              </div>
            ...
            <div className="col-12 col-md-3 mt-5">
              <div className="feature-primary features">
                <div className="d-inline-block position-relative image">
                  <i className="text-primary bi bi-sliders h2"></i>
                </div>
                <div className="content mt-4">
                  <h5>Clutter-Free Experience</h5>
                  <p className="text-muted mb-0">
                    Expert assistance whenever you need it, ensuring smooth
                    operations.
                  </p>
            ...
            <div className="col-12 col-md-3 mt-5">
              <div className="feature-primary features">
                <div className="d-inline-block position-relative image">
                  <i className="text-primary bi bi-check-circle h2"></i>
                </div>
                <div className="content mt-4">
                  <h5>100% Satisfaction Guarantee</h5>
                  <p className="text-muted mb-0">
                    Your success is our priority—risk-free services with a
      ...
      <section className="bg-light border-bottom section">
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="d-flex">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted mb-0">
                    Scrappio simplifies data extraction by automating the
                    collection, organization, and analysis of information from
                    various online sources—giving you accurate insights with
                    minimal effort.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
              <div className="d-flex">
                <span className="text-primary h5 me-2 mt-1">
                  <i className="bi bi-question-circle"></i>
                </span>
            ...
            <div className="col-12 col-md-6 mt-4 pt-2">
              <div className="d-flex">
                <span className="text-primary h5 me-2 mt-1">
                  <i className="bi bi-question-circle"></i>
                </span>
            ...
            <div className="col-12 text-center">
              <div className="section-title">
                ...
                <p className="text-muted mx-auto para-desc">
                  Start working with
                  <span className="text-primary fw-bold"> Scrappio </span> that
