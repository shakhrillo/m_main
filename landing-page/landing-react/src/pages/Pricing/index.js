            ...
            <div class='col-lg-12 text-center'>
              <div class='pages-heading title-heading'>
                ...
                <p class='text-white-50 mb-0 mx-auto para-desc'>
                  Choose a flexible pricing plan that fits your needs and budget, with transparent
                  costs, scalable features, and no hidden fees.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class='ms-lg-4'>
                ...
                <div class='section-title'>
                  ...
                  <p class='text-muted'>
                    ...
                    digital solutions. With expertise in web and mobile development, UI/UX design,
                    digital marketing, and IT consulting, we help businesses grow and thrive in the
                    digital world. <br />
                    <br />
                    Our mission is to provide high-quality, scalable, and results-driven solutions
                    tailored to each client’s unique needs. We believe in a customer-centric
                    approach, where technology meets creativity to build products that stand out.
                    <br />
                    <br />
                    With years of experience and a commitment to excellence, we ensure that every
            ...
            <div class='col col-12'>
              <div class='text-center mb-4 pb-2 section-title'>
                ...
                <p class='text-muted mb-0 mx-auto para-desc'>
                  Our process is simple, transparent, and designed to deliver the best results
                  efficiently.
                </p>
              </div>
            </div>
          ...
          <div class='row'>
            <div class='col-12 col-lg-4 col-md-6 mt-4 pt-2'>
              <div class='card bg-light border-0 rounded shadow business-rate pricing pricing-primary'>
                <div class='card-body'>
                  <h6 class='text-primary text-uppercase fw-bold mb-4 name title'>Starter</h6>
                  <div class='d-flex mb-4'>
            ...
            <div class='col-12 col-lg-4 col-md-6 mt-4 pt-2'>
              <div class='card border-0 rounded shadow business-rate pricing pricing-primary'>
                <div class='overflow-hidden ribbon ribbon-right ribbon-warning'>
                  <span class='d-block shadow text-center h6 small'> Best </span>
                </div>
                <div class='card-body'>
                  <h6 class='text-primary text-uppercase fw-bold mb-4 name title'>professional</h6>
                  <div class='d-flex mb-4'>
                    <span class='h4 mb-0 mt-2'>$</span>
                      ...
                      <div class='d-flex client-testi' name='clientsreview'>
                        ...
                        <div class='flex-1 bg-white p-3 position-relative rounded shadow w-100 content'>
                          ...
                          >
                            ...
                            <p class='text-muted mt-2'>"Thanks a ton! Great job!"</p>
