            ...
            <div className='col-lg-12 text-center'>
              <div className='pages-heading title-heading'>
                ...
                <p className='text-white-50 mb-0 mx-auto para-desc'>
                  Comprehensive solutions to elevate your business with cutting-edge technology and
                  expert services.
                </p>
              </div>
            </div>
          ...
          <div className='row align-items-center'>
            <div className='col-lg-3 col-md-6'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  <a className='text-dark h5 title'>Web Development</a>
                  <p className='text-muted mt-2'>
                    Custom websites and web applications built for performance and scalability.
                  </p>
                  <Link
                    to={'/single-service/web-development'}
            ...
            <div className='col-lg-3 col-md-6 mt-lg-0 pt-2 pt-lg-0'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  <a className='text-dark h5 title'>Mobile App Development</a>
                  <p className='text-muted mt-2'>
                    Cross-platform mobile apps with seamless user experiences.
                  </p>
                  <Link
                    to={'/single-service/mobile-app-development'}
                    className='position-relative text-primary read-more z-1'
                  >
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
            ...
            <div className='col-lg-3 col-md-6 mt-lg-0 pt-2 pt-lg-0'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  ...
                  <Link
                    to={'/single-service/ui-ux-design'}
                    className='position-relative text-primary read-more z-1'
                  >
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
            ...
            <div className='col-lg-3 col-md-6 mt-lg-0 pt-2 pt-lg-0'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  ...
                  <p className='text-muted mt-2'>
                    Optimize visibility and grow your business with strategic marketing.
                  </p>
                  <a className='position-relative text-primary read-more z-1' href=''>
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
                  </a>
            ...
            <div className='col-lg-3 col-md-6 mt-4 pt-2'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  ...
                  <p className='text-muted mt-2'>
                    Scalable cloud solutions and DevOps automation for efficiency.
                  </p>
                  <a className='position-relative text-primary read-more z-1' href=''>
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
            ...
            <div className='col-lg-3 col-md-6 mt-4 pt-2'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  ...
                  <p className='text-muted mt-2'>
                    Expert guidance to improve technology and business processes.
                  </p>
                  <a className='position-relative text-primary read-more z-1' href=''>
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
            ...
            <div className='col-lg-3 col-md-6 mt-4 pt-2'>
              <div className='card border-0 p-4 shadow course-feature feature-clean features overflow-hidden'>
                ...
                <div className='card-body p-0 mt-4'>
                  ...
                  <p className='text-muted mt-2'>
                    Custom online stores with secure payment and seamless shopping experiences.
                  </p>
                  <a className='position-relative text-primary read-more z-1' href=''>
                    Read More
                    <i className='bi bi-chevron-right fw-bolder small'></i>
            ...
            <div className='col-12'>
              <div className='text-center mb-4 pb-4 section-title'>
                ...
                <p className='text-muted mb-0 mx-auto para-desc'>
                  Our streamlined process ensures efficiency, quality, and seamless execution from
                  start to finish.
                </p>
              </div>
            </div>
                ...
                <div className='card bg-transparent border-0 text-center feature-clean feature-primary features process-arrow work-process'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='text-muted mb-0'>
                      We begin by understanding your goals and crafting a strategic plan tailored to
                      your needs.
                    </p>
                  </div>
                </div>
              ...
              <div className='col-md-4 mt-4 mt-md-5 pt-2 pt-md-3'>
                <div className='card bg-transparent border-0 text-center feature-clean feature-primary features process-arrow work-process'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='text-muted mb-0'>
                      Our team designs, builds, and implements high-quality solutions with seamless
                      integration.
                    </p>
                  </div>
                </div>
              ...
              <div className='col-md-4 mt-4 mt-md-5 pt-2 pt-md-5'>
                <div className='card bg-transparent border-0 text-center feature-clean feature-primary features work-process'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='text-muted mb-0'>
                      We deploy your project, ensure everything runs smoothly, and provide
                      continuous support.
                    </p>
                  </div>
                </div>
                ...
                <div className='col-12 text-center'>
                  <div className='position-relative section-title z-1'>
                    ...
                    <p className='text-white-50 mx-auto para-dark para-desc'>
                      We provide innovative strategies, cutting-edge technology, and expert guidance
                      to help your business grow, optimize operations, and stay ahead in a
                      competitive market.
                    </p>
            ...
            <div className='col-md-12'>
              <div className='text-center text-md-start section-title'>
                ...
                <p className='text-muted mb-0 para-desc'>
                  We deliver tailored digital solutions, from web and mobile development to design,
                  marketing, and IT consulting, to help your business thrive.
                </p>
              </div>
            </div>
          </div>
                      ...
                      <tbody>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Overview</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              We build high-performance web and mobile applications tailored to your
                              needs.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Technologies Used</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              HTML, CSS, JavaScript, React, Vue, Flutter, Dart, Next.js, Node.js,
                              Firebase.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Key Features</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Scalable architecture, responsive design, high security, and seamless
                              UX.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Industries Served</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              E-commerce, Fintech, Healthcare, Education, Travel, and more.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Development Process</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Planning → UI/UX Design → Development → Testing → Deployment →
                              Maintenance.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Why Choose Us?</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Experienced team, modern tech stack, agile methodology, and continuous
                              support.
                            </p>
                          </td>
                        </tr>
                    ...
                    <table className='table table-center mb-0'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              We create modern, intuitive, and visually appealing designs to enhance
                              user experience.
                            </p>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              UX research, wireframing, prototyping, responsive design, and design
                              systems.
                            </p>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Design Process</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Research → Wireframing → Prototyping → UI Design → Testing →
                              Finalization.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              User-centric approach, pixel-perfect designs, and seamless brand
                              consistency.
                            </p>
                          </td>
                        </tr>
                    ...
                    <table className='table table-center mb-0'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              We help businesses grow by increasing online visibility, driving
                        ...
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Google Analytics, Google Ads, Meta Ads, Ahrefs, SEMrush, Mailchimp.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              SEO, PPC advertising, social media marketing, email campaigns, and
                              content marketing.
                            </p>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Marketing Process</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Research → Strategy Planning → Execution → Optimization → Reporting.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Data-driven strategies, targeted campaigns, and measurable results.
                            </p>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <table className='table table-center mb-0'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              We provide expert guidance to optimize technology, business
                        ...
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Cloud Solutions, DevOps, AI & Machine Learning, Business Intelligence,
                              Cybersecurity.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              IT strategy, process automation, digital transformation, risk
                              assessment, and scalability planning.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              E-commerce, Fintech, Healthcare, Education, Logistics, and more.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td className='p-3 text-start'>
                            <p className='text-primary fw-bold mb-0'>Consulting Process</p>
                          </td>
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Analysis → Strategy Development → Implementation → Optimization →
                              Continuous Support.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className='p-3 small'>
                            <p className='forum-price mb-0'>
                              Deep industry expertise, innovative solutions, and a results-driven
                              approach.
                            </p>
                          </td>
                        </tr>
