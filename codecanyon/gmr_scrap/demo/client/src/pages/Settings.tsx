...
const SETTINGS_TABS = [
  {
    ...
    fields: [
      ...
      },
      {
        tag: "security",
        label: "Security",
        helpText: "The security of the website.",
        inputType: "textarea",
      },
      {
        tag: "help",
        label: "Help",
        helpText: "The help of the website.",
        inputType: "textarea",
      },
      {
        tag: "terms",
    ...
    fields: [
      {
        tag: "cost",
        label: "Cost",
        helpText: "The cost of each coin.",
        inputType: "text",
      },
      {
        tag: "bonus",
        label: "Bonus",
        helpText: "The bonus of each coin.",
        inputType: "text",
      },
      {
        tag: "image",
        label: "Image",
        helpText: "The cost of each image in coins.",
        inputType: "text",
      },
      {
        tag: "video",
        label: "Video",
        helpText: "The cost of each video in coins.",
        inputType: "text",
      },
      {
        tag: "response",
        label: "Response",
        helpText: "The cost of each response in coins.",
        inputType: "text",
      },
      {
        tag: "review",
        label: "Review",
        helpText: "The cost of each review in coins.",
        inputType: "text",
      },
      {
        tag: "validation",
        label: "Validation",
        helpText: "The cost of each validation in coins.",
        inputType: "text",
      },
    ],
  },
    ...
    fields: [
      {
        tag: "minimum",
        label: "Minimum",
        helpText: "The minimum of scrapes.",
        inputType: "text",
      },
      {
        tag: "maximum",
        label: "Maximum",
        helpText: "The maximum of scrapes.",
        inputType: "text",
      },
      {
        tag: "retries",
        label: "Retries",
        helpText: "The retries of scrapes.",
        inputType: "text",
      },
    ],
  },
